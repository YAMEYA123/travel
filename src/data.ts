...
export const days: TripDay[] = [
  {id:'d0',day:0,date:'9月25日',weekday:'周五',city:'阿姆斯特丹',country:'NL',title:'抵达阿姆斯特丹',hotel:'Holiday Inn Express Amsterdam - Sloterdijk',activities:[
    a('d0-1','19:00','抵达史基浦机场','航班落地；不要把落地时间当成出站时间','train'),a('d0-2','19:00–20:15','入境、取行李与进站','按60–75分钟弹性预留，延误时直接压缩晚餐','note',{important:true}),a('d0-3','20:15后','史基浦 → Sloterdijk','乘直达NS列车，不绕行中央站；下车即到酒店','train',{cost:'约€5.50',payment:'OVpay：非接触式 Visa/Mastercard，同一张卡进出站'}),a('d0-4','约21:00','办理入住与简餐','附近简单晚餐，早点休息','hotel',{booked:true})]},
  {id:'d1',day:1,date:'9月26日',weekday:'周六',city:'羊角村 · 阿姆斯特丹',country:'NL',title:'水乡与安妮之家',hotel:'Holiday Inn Express Amsterdam - Sloterdijk',note:'羊角村若返程延误，直接取消九街，确保安妮之家预约。',activities:[
    a('d1-0','08:20','酒店 → 阿姆斯特丹中央站','预留换乘和找站台时间','train',{payment:'OVpay：非接触式 Visa/Mastercard，同一张卡进出站'}),a('d1-1','09:00','中央站 → Steenwijk','NS 火车约1小时25分钟；OVpay按二等座无折扣票价计费','train',{cost:'约€20',payment:'OVpay：每人各刷一张卡，抵达后用原卡出站'}),a('d1-1a','10:30','Steenwijk → 羊角村','换乘巴士；上车刷入、下车刷出，班次不合适时改出租车','bus',{payment:'OVpay：可直接刷非接触式 Visa/Mastercard 或手机钱包'}),a('d1-2','11:00–12:30','羊角村水道','优先先租船，避开午后客流','sight',{important:true}),a('d1-2a','12:30–13:15','羊角村午餐','选靠近主水道的简餐','food'),a('d1-2b','13:15–14:30','茅草屋村落漫步','步行桥、运河与经典村景','sight'),a('d1-3','14:30–16:30','返回阿姆斯特丹','公交回Steenwijk后换乘NS；各运营商分别刷出/刷入，抵达中央站后直接进城','train',{payment:'OVpay：全程可刷 Visa/Mastercard；始终使用同一张卡或同一台设备'}),a('d1-4','17:15–18:20','九街','仅在返程准点时安排，之后步行去安妮之家','sight'),a('d1-5','19:00','安妮之家','提前15分钟抵达预约入口','sight',{cost:'€16.50',important:true}),a('d1-6','20:30','晚餐并返回酒店','以中央站附近简餐为主','food')]},
  {id:'d2',day:2,date:'9月27日',weekday:'周日',city:'阿姆斯特丹 → 科隆',country:'NL',title:'两大博物馆与夜车',hotel:'Hilton Cologne',note:'最迟19:50返回中央站；IC 60403为自由座，建议提前上车。',activities:[
    a('d2-0','08:15','退房并寄存行李','行李寄存在Sloterdijk酒店，不带去博物馆','hotel',{important:true}),a('d2-0a','08:30','前往博物馆广场','预留约30分钟交通和入场缓冲','train',{payment:'OVpay：非接触式 Visa/Mastercard，同一张卡进出站'}),a('d2-1','09:15–11:15','梵高博物馆','精选参观2小时，现场无票','sight',{cost:'€25',important:true}),a('d2-1a','11:20–12:05','博物馆广场简餐','避免两个博物馆之间没有午餐','food'),a('d2-2','12:15–14:30','国立博物馆','重点看《夜巡》《倒牛奶的女仆》','sight',{cost:'€21.50'}),a('d2-3','15:00–17:30','Jordaan与九街','运河散步；前一天已逛九街可缩短','sight'),a('d2-3a','17:30–18:15','提前晚餐','夜车前吃完正餐','food'),a('d2-4','18:20–19:10','回酒店取行李','从市中心返回Sloterdijk后再去中央站','note',{important:true,payment:'市内段可用 OVpay；换乘不同运营商时分别刷出、刷入'}),a('d2-4a','19:30','抵达中央站','核对站台并提前候车','train'),a('d2-5','21:01','IC 60403 → 科隆','直达2小时44分，23:45抵达','train',{booked:true,important:true,cost:'已购 · 自由座',payment:'使用已购国际列车票，不刷 OVpay'}),a('d2-6','23:45','入住 Hilton Cologne','车站步行约2分钟','hotel',{booked:true})]},
  ...
  {id:'d6',day:6,date:'10月1日',weekday:'周四',city:'萨尔茨堡',country:'AT',title:'萨尔茨堡老城与入住',hotel:'萨尔茨堡住宿（待预订）',note:'第一晚住萨尔茨堡；两只26寸箱先放酒店，今天只安排老城景点。',activities:[
    a('d6-0','08:30','早餐与前往酒店','抵达后先寄存两只26寸箱，带轻便日包进城','hotel'),a('d6-1','09:00–10:00','莫扎特出生地','官方建议参观约1小时','sight'),a('d6-2','10:15–11:45','霍亨萨尔茨堡要塞','乘缆车上下，减少拖箱和爬坡负担','sight',{important:true}),a('d6-3','11:45–13:00','老城午餐','格特雷德街附近简餐','food'),a('d6-4','13:00–15:00','米拉贝尔花园与萨尔茨堡老城','按体力补看街区，不再安排远端湖区','sight'),a('d6-5','15:00','回酒店办理入住','确认次日去圣沃尔夫冈的公交、船班和行李寄存','hotel'),a('d6-6','18:00','酒店附近晚餐','早点休息，为湖区转场留体力','food')]},
  {id:'d7',day:7,date:'10月2日',weekday:'周五',city:'圣沃尔夫冈',country:'AT',title:'萨尔茨堡 → 圣沃尔夫冈',hotel:'圣沃尔夫冈住宿（待预订）',note:'第二晚住圣沃尔夫冈；公共交通转场，建议让酒店确认可提前寄存行李。',activities:[
    a('d7-1','08:00','早餐、退房与取行李','两只26寸箱装好，避免当天多次整理','hotel'),a('d7-2','08:45–10:30','萨尔茨堡 → 圣吉尔根','乘150/150X路公交，确认行李可放置位置','bus',{payment:'上车前确认售票方式；准备非接触式Visa/Mastercard和少量现金'}),a('d7-3','10:45–11:30','圣吉尔根 → 圣沃尔夫冈','根据船班选择沃尔夫冈湖渡轮；带大箱时优先坐船减少陆路换乘','boat',{important:true}),a('d7-4','11:30–12:15','酒店寄存行李与午餐','先把两只26寸箱交给酒店，再轻装游览','hotel'),a('d7-5','12:15–15:30','圣沃尔夫冈湖滨与小镇','教堂、湖滨步道和码头，天气差就缩短','sight'),a('d7-6','15:30–17:00','可选夏夫山铁路/湖畔散步','只在天气和体力允许时选择一个，不叠加长途项目','sight'),a('d7-7','18:00','圣沃尔夫冈入住与晚餐','确认次日前往巴德伊舍的公交班次','hotel')]},
  {id:'d8',day:8,date:'10月3日',weekday:'周六',city:'巴德伊舍',country:'AT',title:'圣沃尔夫冈 → 巴德伊舍',hotel:'巴德伊舍住宿（待预订）',note:'第三晚住巴德伊舍；上午在圣沃尔夫冈轻装活动，下午公交转场。',activities:[
    a('d8-0','08:30','早餐与退房','先确认巴德伊舍酒店可寄存行李','hotel'),a('d8-1','09:00–11:00','圣沃尔夫冈湖滨晨间散步','避开团队客流，拍照后回酒店取行李','sight'),a('d8-2','11:00–11:45','取行李与午餐','两只26寸箱随身，选择码头或车站附近简餐','food'),a('d8-3','12:00–13:30','圣沃尔夫冈 → 巴德伊舍','乘区域公交，经Strobl方向转场；班次以当天时刻表为准','bus',{important:true,payment:'上车前确认售票方式；准备非接触式Visa/Mastercard和少量现金'}),a('d8-4','13:30–14:00','酒店寄存行李','先寄存大件，再开始下午活动','hotel'),a('d8-5','14:00–16:30','巴德伊舍小镇与皇帝别墅周边','以步行为主，咖啡馆和河畔散步为主线','sight'),a('d8-6','17:00','巴德伊舍入住与晚餐','为次日去哈尔施塔特或维也纳预留选择空间','hotel')]},
  {id:'d9',day:9,date:'10月4日',weekday:'周日',city:'巴德伊舍 → 维也纳',country:'AT',title:'巴德伊舍转维也纳',hotel:'DoubleTree Vienna Schönbrunn',note:'从巴德伊舍出发前往维也纳；根据车次选择经Attnang-Puchheim转乘的ÖBB路线。',activities:[
    a('d9-0','08:00','早餐、退房与取行李','确认两只26寸箱轮子和拉杆可正常使用','hotel'),a('d9-1','08:30–09:00','前往巴德伊舍车站','预留车站找站台和搬运行李时间','walk'),a('d9-2','09:15–13:30','巴德伊舍 → 维也纳','ÖBB区域列车换乘，提前订座并把大箱放在行李架','train',{important:true,cost:'待购'}),a('d9-3','约14:00','抵达维也纳并入住','先办理入住或寄存行李','hotel'),a('d9-4','15:00–17:00','美泉宫周边轻松活动','不拖箱穿越老城，按体力安排','sight'),a('d9-5','18:00','酒店附近晚餐','整理次日美泉宫与机场资料','food')]},
...
export const bookings: Booking[] = [
  ...
  {id:'b3a',date:'10月1日',title:'萨尔茨堡住宿',detail:'第1晚；确认可提前寄存两只26寸行李箱',price:'待订',status:'urgent'},
  {id:'b3c',date:'10月2日',title:'圣沃尔夫冈住宿',detail:'第2晚；确认公交/渡轮抵达后可寄存行李',price:'待订',status:'urgent'},
  {id:'b3d',date:'10月3日',title:'巴德伊舍住宿',detail:'第3晚；靠近车站，方便次日携箱转乘ÖBB',price:'待订',status:'urgent'},
...
export const route = [
  ...
  {city:'萨尔茨堡·湖区',code:'SZG',date:'9/30–10/3',country:'AT'},
